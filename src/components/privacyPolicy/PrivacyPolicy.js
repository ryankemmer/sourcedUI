  ...
  return (
    <main className="privacy">
      ...
      <section id="intro" className="policy-card">
        <p>
          Thank you for using SourcedFinds.com (“we,” “us,” or “our”). This Privacy Policy explains how we collect,
          use, and protect your information when you use our application, which connects to your Pinterest
          account to generate a personalized feed of Poshmark listings (“Service”).
        </p>
      </section>
      ...
      <section id="info-we-collect" className="policy-card">
        ...
        <p>
          We may retrieve product data, listing details, and images from Poshmark’s public APIs or listings.
      ...
      <section id="third-party" className="policy-card">
        ...
        <ul className="dash-list">
          ...
          <li>We only access Pinterest data as permitted by Pinterest’s API and OAuth authorization.</li>
